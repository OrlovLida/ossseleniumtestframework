...
public class Notifications implements NotificationsInterface {
    ...
    private static final String NOTIFICATION_LABEL = ".//div[@class='notificationLabel']";
    private static final String NOTIFICATION_CONTAINER = "//div[@class='notificationContainer']";
    private static final String NOTIFICATION_TEXT_CONTAINER = "//div[@class='notificationTextContainer']";
    private static final String NOTIFICATION_BY_TEXT_AND_STATUS = "/span[contains(text(), '%s') and contains(text(), '%s')]";
    ...
    public String getNotificationMessage() {
        ...
        DelayUtils.waitByXPath(wait, NOTIFICATION_LABEL);
        wait.until(ExpectedConditions.not(ExpectedConditions
                .attributeToBe(driver.findElement(By.xpath(NOTIFICATION_CONTAINER + "/div")), "class", "notification progressNotification")));
        String notificationText =
                wait.until(ExpectedConditions
                        .visibilityOf(driver.findElement(By.xpath(NOTIFICATION_LABEL + NOTIFICATION_TEXT_CONTAINER + "/span"))))
                        .getText();
    ...
    public void waitForNotification(String text, String notificationStatus) {
        openNotificationContainer();
        String notificationByTextAndStatus = String.format(NOTIFICATION_BY_TEXT_AND_STATUS, text, notificationStatus);
        DelayUtils.waitByXPath(wait, NOTIFICATION_LABEL + NOTIFICATION_TEXT_CONTAINER + notificationByTextAndStatus);
        clickOnWebElement(driver.findElement(CLEAR_NOTIFICATION));
    }
