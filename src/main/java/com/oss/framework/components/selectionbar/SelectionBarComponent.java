...
public class SelectionBarComponent {
    ...
    private static final String SHOW_SELECTED_ONLY_BUTTON_ACTIVE_CSS = "[" + CSSUtils.TEST_ID + "='show-selected-only-button]";
    ...
    private boolean isShowSelectedPresent() {
        return !widget.findElements(By.xpath(SHOW_SELECTED_ONLY_BUTTON_ACTIVE_CSS)).isEmpty();
    }
}
