...
public class OldActionsContainer implements ActionsInterface {
    ...
    public void callActionByLabel(String label) {
        DelayUtils.waitForNestedElements(wait, this.toolbar,
                ".//a[contains(text(),'" + label + "')] | .//i[contains(@aria-label,'" + label + "')]");
        WebElement action =
                this.toolbar.findElement(By.xpath(".//a[contains(text(),'" + label + "')] | .//i[contains(@aria-label,'" + label + "')]"));
    ...
    public void callAction(String groupId, String actionId) {
        ...
        wait.until(
                ExpectedConditions.elementToBeClickable(toolbar.findElement(By.xpath(".//li[@data-group-id='" + groupId + "']//button"))))
                .click();
        wait.until(ExpectedConditions
                .elementToBeClickable(By.xpath("//ul[contains(@class,'widgetList')]//a[@data-attributename='" + actionId + "']"))).click();
