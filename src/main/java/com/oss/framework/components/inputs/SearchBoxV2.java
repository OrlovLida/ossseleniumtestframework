...
public class SearchBoxV2 extends Input {
    ...
    private SearchBoxV2(WebDriver driver, WebDriverWait wait, String componentId) {
        super(driver, wait, componentId);
    }

    private SearchBoxV2(WebElement parent, WebDriver driver, WebDriverWait wait, String componentId) {
        super(parent, driver, wait, componentId);
    }

    static SearchBoxV2 create(WebDriver driver, WebDriverWait wait, String componentId) {
        return new SearchBoxV2(driver, wait, componentId);
    }

    static SearchBoxV2 createFromParent(WebElement parent, WebDriver driver, WebDriverWait wait, String componentId) {
        return new SearchBoxV2(parent, driver, wait, componentId);
    }
