...
public class PropertiesFilterPanel {
    ...
    private static final String CHECKBOXES = ".//input[@id]";
    private static final String CHECKBOX_LABELS = ".//label[@title]";
    ...
    public List<String> getCheckboxLabels() {
        ...
        for (WebElement element : this.webElement.findElements(By.xpath(CHECKBOX_LABELS))) {
